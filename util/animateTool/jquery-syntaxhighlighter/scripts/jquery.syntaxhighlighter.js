	...
	if ( !($.SyntaxHighlighter||false) ) {
		$.SyntaxHighlighter = {
			...
			'config': {
				 ...
				 */
				'prettifyBaseUrl': false ? '/case/css3/jquery-syntaxhighlighter/prettify' : '/case/css3/jquery-syntaxhighlighter/prettify',

				/**
				 * The baseUrl to load our Syntax Highlighter from.
				 * This is used to load in the stylesheet and additional themes.
				 */
				'baseUrl': false ? '/case/css3/jquery-syntaxhighlighter' : '/case/css3/jquery-syntaxhighlighter'
			},
